import pygame
import json
from configuratie import breedte, hoogte, font , screen, BLAUW ,WIT, ZWART, GROEN, BRUIN,GRIJS
...
def toon_submenu():
    ...
    knop_terug = pygame.Rect(300, hoogte - 80, 330, 50)
    ...
    while menu_running:
        ...
        tekst = font.render("Mode:", True, ZWART)
        screen.blit(tekst, (knop_rect.x + 10, knop_rect.y + 25))

        tekst1_1 =   klein_font.render("vind de uitgang", True, ZWART)
        screen.blit(tekst1_1, (knop_rect.x + 10, knop_rect.y + 60))

        tekst2 = font.render("Mode:", True, ZWART)
